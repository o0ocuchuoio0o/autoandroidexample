...
namespace TestPanel
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            ProcessStartInfo psi = new ProcessStartInfo(@"C:\Users\Workstation Z400\Desktop\LDPlayer-2.lnk");           
            ...
            ProcessStartInfo psi2 = new ProcessStartInfo(@"C:\Users\Workstation Z400\Desktop\LDPlayer.lnk");
            psi2.UseShellExecute = true;
            psi2.CreateNoWindow = true;
            psi2.WindowStyle = ProcessWindowStyle.Maximized;
            psi2.RedirectStandardInput = false;
